                ...
                $returnobj= mysqli_query( $connect, "SELECT * FROM guide AS g JOIN city AS ct ON g.City_ID = ct.City_ID WHERE guide_id = '$guide_id'" )
                  or die("Can not execute query");
                    ...
                    while( $rows = mysqli_fetch_array( $returnobj ) ) {
                      ...
                      <br>
                      <input class="text" type="text" id="contact_no" name="contact_no" size="40px" value="0<?php echo $Contact_no ?>"readonly>
                      <br><br>
                      <label for="email">Email</label>:
                      <br>
                      <input class="text" type="text" id="email" name="email" size="40px" value="<?php echo $Email ?>"readonly>
                      <br><br>
                      <label for="bank_acc">NID</label>:
                      <br>
                      <input class="text" type="text" id="nid" name="nid" size="40px" value="<?php echo $nid?>"readonly>
                      <br><br>
                      <label for="joining_date">Joining Date</label>:
                      <br>
                      <input class="text" id="joining_date" name="joining_date" size="40px" value="0<?php echo $Joining_Date ?>"readonly>
                      <br><br>
                      ...
                      if($access == 'admin'){
                          ?>
                              ...
                              <br>
                              <input class="text" type="text" id="address" name="address" size="40px" value="<?php echo $Address?>"readonly>
                              <br><br>
                              <label for="addrees">Bank Account</label>:
                              <br>
                              <input class="text" type="text" id="bank_acc" name="bank_acc" size="40px" value="<?php echo $Bank_Account_no ?>"readonly>
                              <br><br>
