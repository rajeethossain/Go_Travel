                      ...
                      <tbody>
                        ...
                        <?php
                                      ...
                                      <tr>
                                          ...
                                          if($access  == 'admin'){
                                            ...
                                            <td>
                                              ...
                                              <br><br>
                                              <input id="button" type="button" value="Reject" onclick="rejectGuide('<?php echo $guide_id ?>');">
                          ...
                          function approveGuide(guide_id){
                            location.assign('guide_approve.php?guide_id='+guide_id);
                          }
                          function rejectGuide(guide_id){
                            location.assign('guide_approve.php?guide_id='+guide_id);
                          }
